    ...
    <div className="container-fluid bg-white Password-verification-contaner">
      <div className="row">
        <div className="col-lg-12 " style={{ width: "25rem", }}>
          <img src={logo} alt="logo" width={100} height={100} style={{ borderRadius: "50%", marginLeft: "35%" }} className='image mb-3 image-fluid mt-3' />
          <form action="">
            ...
            <div>
              <button type='submit' className='btn btn-primary btn-md w-100 mb-3'>Verify</button>
            </div>
          </form>
        </div>
      </div>
